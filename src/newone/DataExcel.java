...
public class DataExcel {
	...
	public DataExcel(int point, int a, int b, int c, int d, int e, double pointRage, String rule) {
		this.rule = rule;
		a = impressive;
		b = happy;
		c = normal;
	...
	public double getPointRage() {
		return pointRage;
	}
	public void setPointRage(double pointRage) {
		this.pointRage = pointRage;
	}

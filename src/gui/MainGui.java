...
public class MainGui extends JFrame implements ActionListener, MouseListener, ItemListener {
	...
	private static double pointrage = 100;
	private JPanel BtnPanel;
	private JButton btnNewButton_2;
	private JButton btnNewButton_3;
	private static int bgMode = 1;
	private static JLabel showKetQua, ruleLabel, lblNewLabel_5, lblNewLabel_1, lblNewLabel_2, lblNewLabel, lblNewLabel_3, orderBG;
	private static JButton reloadButton, getLinkExcelBtn, modeVatCanBtn, soundBtn, loadLabelRuleBtn, btnNewButton_1, btnNewButton;
	private static JPanel panelOrder;
...
//		menu.setVisible(false);
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				MainGui.setOrderString("");
				ruleLabel.setText("");
				MainGui.setSaveRule(new ArrayList<>());
			}
		});
		btnNewButton_5.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnNewButton_5.setBounds(230, 218, 111, 30);
		panelOrder.add(btnNewButton_5);
...
//							System.out.println(df.format((int) (getLuongPin() / getLuongPinSetUp()) * 100) + "%");
	...
	private JMenuBar createMenu() {
		...
		JMenu addTimeToDo = new JMenu("Other");
...
//		saveRule = new ArrayList<>();
	...
	public static double getPointrage() {
		return pointrage;
	}

	public static void setPointrage(double pointrage) {
		MainGui.pointrage = pointrage;
	}
}
